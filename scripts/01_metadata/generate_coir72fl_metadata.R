# Generate variable metadata JSON for COIR72FL dataset
...
# Generate metadata for COIR72FL
coir72fl_file <- "data/raw/COIR72SD/COIR72FL.SAS7BDAT"
if (file.exists(coir72fl_file)) {
  generate_metadata_json(coir72fl_file)
} else {
  cat("File not found:", coir72fl_file, "\n")
}
