# Generate variable metadata JSON for COIR61FL dataset
# Same logic as generate_coir72fl_metadata.R
...
# Generate metadata for COIR61FL
coir61fl_file <- "data/raw/COIR61SD/COIR61FL.SAS7BDAT"
if (file.exists(coir61fl_file)) {
  generate_metadata_json(coir61fl_file)
} else {
  cat("File not found:", coir61fl_file, "\n")
}
